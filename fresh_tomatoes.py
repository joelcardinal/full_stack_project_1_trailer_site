...
<head>
    ...
    <style type="text/css" media="screen">
        ...
        .navbar-brand {{
            ...
            color: #000;
            font-weight: bold;
            text-shadow: 2px 0px 0px rgb(234, 82, 82);
        }}
      ...
      <div class="navbar navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <h1 class="navbar-brand">{page_titles}</h1>
          </div>
        </div>
      </div>
    </div>
...
def open_movies_page(movies, page_title):
    ...
    # Set page title
    rendered_page_head =  main_page_head.format(page_titles=page_title)
